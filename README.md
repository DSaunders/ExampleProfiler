...
The Console Application's runtime will load the profiler. This happens automatically, the code in the Console Application has no knowledge of the profiler.
